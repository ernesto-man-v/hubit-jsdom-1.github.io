...
const fillCatCardTemplate = ({name, img_link, age, rate, favourite, description, id}) => `
    <div class="card">
        <div class="card-top">
        <span>${id}.</span>
            ${name}
        ...
        <div class="card-main">
            <img class="card-main__image" src="${img_link}" alt="image">
        </div>
        <div class="card-bottom">
            <div class="card-bottom__info">
                <div class="card-bottom__info-rate">
                    Возрасть: ${age}
                </div>
                <div class="card-bottom__info-rate">
                    Рейтинг: ${rate}
                </div>
                <div class="card-bottom__info-favourite">
                    ${favourite ? '&starf;' : '&star;'}
                </div>
            </div>
...
function renderCatCards(cats) {
    ...
    rootElement.innerHTML = cats.reduce((acc, cat) => acc += fillCatCardTemplate(cat), '')
}
